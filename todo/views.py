...
def loginuser(request):
    if request.method =='GET':
        ...
        if user is None:
            return render(request,'todo/loginuser.html',{'form':UserCreationForm(),'error':"username password did not match"})
        else:
            login(request,user)
            return redirect('currenttodos')
...
def viewtodos(request,todo_pk):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request,'todo/viewtodos.html',{'todo':todo,'form':form,'error':"wrong Information. Please Try Again"})
...
def createtodos(request):
    if request.method == "GET":
        ...
        try:
            ...
            return render(request,'todo/createtodos.html',{'form':Todoform(),'error':"Title too long"})
